...
GenoraAI is an AI-powered web application generator that transforms your ideas into fully functional, live web apps through simple text prompts. Built with Next.js 16, it leverages cutting-edge AI to create, preview, and share web applications in real-time.
...
```bash
git clone https://github.com/prabuddhaxdev/GenoraAI.git
cd genora
```
...
2. **AI Generation**: GenoraAI's AI analyzes your prompt and generates the complete application code
